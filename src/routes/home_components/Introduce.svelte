<div class="introduce">
	<div class="introduce-content">
		...
		<div class="right">
			...
			<p class="text-light">
				인공지능 기반 PTSD 치료 서비스를 개발하던 초기 스타트업에서 코파운더로 합류해 Flutter,
				gRPC, Firebase 등을 활용한 기술 스택을 결정하고, Git 관리 방식을 도입했습니다. 또한,
				On-premise 서버를 구축하며 제한된 자원으로 서비스를 안정적으로 운영하는 방법을 익혔습니다.
				비록 해당 서비스는 자금 부족으로 마무리되었지만, 이 경험을 바탕으로 더 나은 세상을 위한
				서비스에 기여하는 엔지니어로 성장하고자 합니다.
			</p>
